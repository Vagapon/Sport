          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex">
              <input
                ...
                className="px-4 py-3 bg-slate-800 border border-slate-600 rounded-l-md focus:outline-none focus:border-red-500 text-white placeholder-gray-400 w-64"
              />
              <button className="bg-red-600 hover:bg-red-700 px-6 py-3 rounded-r-md font-semibold transition-colors duration-300">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              The fact that players change nationalities to play for other clubs is not a surprise.
              We teach our small players to follow the rules, use time & space comprehension and...
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Contacts</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>Address: 123 Football St, Sports City</p>
            </div>
          </div>
        </div>
